...
$SQL = "SELECT email, senha FROM contapaypal WHERE CadUser = :CadUser AND id = :id";
                ...
                <div class=\"modal-content\">
                    ...
                    <div class=\"modal-body form-horizontal form-group-separated\">     
						...
						<div class=\"form-group\">
                            ...
                            <div class=\"col-md-9\">
                                <input id=\"Senha\" name=\"Senha\" type=\"text\" class=\"validate[required] form-control\" value=\"".$Ln['senha']."\">
                            </div>
                        </div>
...
$(function(){  
 $("button.SalvarForma").click(function() { 
		...
		$.post('EnviarAdicionarFormaPayPalEditar.php', Data, function(resposta) {
				$("#StatusModal").html('');

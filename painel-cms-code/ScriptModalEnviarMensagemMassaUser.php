...
$ColunaAcesso = array('UserMensagem');
...
$(function(){  
 $("button.EMensagem").click(function() { 
		...
		$.post('EnviarOpcoesUser.php', {camposMarcados: camposMarcados, assunto: assunto, mensagem: mensagem, status: status, EnviarCOM: EnviarCOM}, function(resposta) {
				$("#StatusModal").html('');

...
$ColunaAcesso = array('UserVisualizar');
$VerificarAcesso = VerificarAcesso('user', $ColunaAcesso);
$UserVisualizar = $VerificarAcesso[0];
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	$SQLUser = "SELECT CadUser, celular FROM usuario WHERE usuario = :usuario";
	...
	if($EnviarSMS == 1){
		echo MensagemAlerta($_TRA['sucesso'], $_TRA['secs'], "success", "index.php?p=usuario");
	}
	else{

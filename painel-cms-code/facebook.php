...
$SQL = "SELECT facebook FROM rede_social WHERE CadUser = :CadUser";
...
?>
	...
	<!-- START BREADCRUMB -->
          ...
          <h2><span class="fa fa-facebook"></span> Facebook</h2>
          </div>
                <!-- END PAGE TITLE -->   
                                        ...
                                        <tr>
											...
											<td>
												<div class=\"form-group\">
													<a onclick=\"Deletar('facebook');\" class=\"label label-danger\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"\" data-original-title=\"".$_TRA['excluir']."\"><i class=\"fa fa-trash-o\"></i></a>
												</div>
											</td>
...
<!-- START SCRIPTS -->
		...
		function Configurar(){
				...
				$.post('ScriptModalConfigurarFacebook.php', function(resposta) {

                ...
                <div class=\"modal-content\">
                    ...
                    <div class=\"modal-body form-horizontal form-group-separated\">     
                        ...
                        <div class=\"form-group\">
                            ...
                            <div class=\"col-md-9\">
                                <input id=\"Email\" name=\"Email\" type=\"text\" class=\"validate[required,custom[email]] form-control\">
                            </div>
                        </div>
						...
						<div class=\"form-group\">
                            ...
                            <div class=\"col-md-9\">
                                <input id=\"Token\" name=\"Token\" type=\"text\" class=\"validate[required] form-control\">
                            </div>
                        </div>
...
$(function(){  
 $("button.SalvarForma").click(function() { 
		...
		$.post('EnviarAdicionarFormaPagSeguro.php', Data, function(resposta) {
				$("#StatusModal").html('');

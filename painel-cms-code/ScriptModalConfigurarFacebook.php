            ...
            <div class=\"modal-dialog\">
                <div class=\"modal-content\">
                    <div class=\"modal-header\">
                        ...
                        <h4 class=\"modal-title\" id=\"smallModalHead\">Configurar Facebook</h4>
                    </div>
                    <div class=\"modal-body form-horizontal form-group-separated\">     
						...
						<div class=\"form-group\">
                        	<label class=\"col-md-3 control-label\">Facebook</label>
                            	<div class=\"col-md-9\">
                                	<input type=\"text\" name=\"RedeSocial\" id=\"RedeSocial\" class=\"form-control\" value=\"".$facebook."\"/>
                                </div>
                        </div>
...
$(function(){  
 $("button.SalvarCaptcha").click(function() { 
		...
		$.post('EnviarConfigurarFacebook.php', Data, function(resposta) {

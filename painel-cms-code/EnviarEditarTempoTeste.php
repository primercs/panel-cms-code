...
$ColunaAcesso = array('TesteTempoEditar');
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	$SQL = "SELECT tempo FROM tempoteste WHERE tempo = :tempo AND id != :id";
	...
	if(empty($SQL)){
		...
		echo MensagemAlerta($_TRA['sucesso'], $_TRA['alcs'], "success", "index.php?p=tempo-teste");
	}

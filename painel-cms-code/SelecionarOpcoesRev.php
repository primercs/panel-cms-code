...
$ColunaAdmin = array('RevVisualizar', 'RevBloquear', 'RevDesativar', 'RevExcluir');
...
$(function(){  
			...
			if(status == 'arvore'){
					...
					$.post('ScriptModalAlterarArvoreRev.php', {camposMarcados: camposMarcados}, function(resposta) {
					...
					$.post('ScriptModalAlterarVencRev.php', {camposMarcados: camposMarcados}, function(resposta) {
					...
					$.post('ScriptModalAlterarPerfilRev.php', {camposMarcados: camposMarcados}, function(resposta) {
					...
					$.post('ScriptModalAlterarValoresRev.php', {camposMarcados: camposMarcados}, function(resposta) {

...
$CadUser = InfoUser(2);
	...
	elseif(empty($RedeSocial)){
		echo MensagemAlerta($_TRA['erro'], "Facebook é um campo obrigatório!", "danger");
	}
	else{
	...
	if(empty($SQL)){
		...
		echo MensagemAlerta($_TRA['sucesso'], "Facebook configurado com sucesso!", "success", "index.php?p=facebook");
	}

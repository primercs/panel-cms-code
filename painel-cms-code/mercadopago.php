...
$SQL = "SELECT id, clientid, clientsecret, bloqueado FROM contamercadopago WHERE CadUser = :CadUser";
...
?>
	...
	<!-- START BREADCRUMB -->
                <ul class="breadcrumb">
                    ...
                    <li class="active"><?php echo $_TRA['MercadoPago']; ?></li>
                </ul>
                <!-- END BREADCRUMB -->  
                
                <!-- PAGE TITLE -->
          <div class="page-title">                    
          <h2><span class="fa fa-chevron-right"></span> <?php echo $_TRA['MercadoPago']; ?></h2>
          </div>
                <!-- END PAGE TITLE -->   
                ...
                <div class="page-content-wrap">                
                    ...
                    <div class="row">
                        ...
                        <div class="panel panel-default">
                               ...
                               <thead>
                               		<tr>
                                    	<th width="150"><?php echo $_TRA['ClientID']; ?></th>
                                        <th><?php echo $_TRA['ClientSecret']; ?></th>
								...
								if($Ln['bloqueado'] == "S"){
									...
									$status = "&nbsp;&nbsp;<span class=\"pointer label label-success\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"\" data-original-title=\"".$_TRA['desbloqueado']."\">".$_TRA['desbloqueado'][0]."</span>";
										...
										echo "
                                        <tr>
											<td>".$Ln['clientid'].$status."</td>
                                        	<td>".$Ln['clientsecret']."</td>
								...
								echo "<a onclick=\"DeletarForma('".$Ln['id']."','".$Ln['clientid']."');\" class=\"label label-danger\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"\" data-original-title=\"".$_TRA['excluir']."\"><i class=\"fa fa-trash-o\"></i></a>&nbsp;";
...
<!-- START SCRIPTS -->
		...
		function BloquearMetodo(id){ 
				...
				var tipo = 'danger';
				var url = 'EnviarBloquearMercadoPago';
				var fa = 'fa fa-lock';  
		...
		function DesbloquearMetodo(id){ 
				...
				var tipo = 'danger';
				var url = 'EnviarDesbloquearMercadoPago';
		...
		function InformacoesForma(id){
				...
				$.post('ScriptModalInfoFormaMercadoPago.php', {id: id}, function(resposta) {
		...
		function DeletarForma(id, clientid){
			 		
 				var titulo = '<?php echo $_TRA['excluir']; ?>?';
				var texto = '<?php echo $_TRA['tcqdea']; ?> '+clientid+'?';
				var tipo = 'danger';
				var url = 'EnviarDeletarFormaMercadoPago';
		...
		function EditarForma(id){  
				...
				panel_refresh($(".page-container")); 
				$.post('ScriptModalFormaMercadoPagoEditar.php', {id: id}, function(resposta) {
		...
		function AdicionarForma(){ 
				...
				$.post('ScriptModalFormaMercadoPago.php', function(resposta) {

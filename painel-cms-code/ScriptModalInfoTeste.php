...
$SQL = "SELECT CadUser, nome, sobrenome, senha, email, celular, foto, perfil, bloqueado, data_cadastro, data_nascimento, VencEmail, VencSMS, data_premio, conexao FROM teste WHERE usuario = :usuario";

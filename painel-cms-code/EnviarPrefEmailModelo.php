...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	$CadUser = InfoUser(2);
	$SQL = "SELECT id FROM email_preferencias WHERE CadUser = :CadUser";
	...
	if($Total > 0){
	$SQL = "UPDATE email_preferencias SET
	...
	$SQL = "INSERT INTO email_preferencias (
			CadUser,
			DadosDeAcesso,
            DadosDeAcessoTeste,
            Vencimento,
	...
	if(empty($SQL)){
		...
		echo MensagemAlerta($_TRA['sucesso'], $_TRA['alcs'], "success", "index.php?p=email-modelo");
	}

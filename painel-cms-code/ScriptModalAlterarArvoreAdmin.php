...
$ColunaAdmin = array('AdminVisualizar');
            ...
            <div class=\"modal-dialog\">
                <div class=\"modal-content\">
                    <div class=\"modal-header\">
                        ...
                        <h4 class=\"modal-title\" id=\"smallModalHead\">".$_TRA['aa']."</h4>
                    </div>
                    ...
                    <div class=\"modal-footer\">
                        ...
                        <button type=\"button\" class=\"SalvarAdicionar btn btn-warning\">".$_TRA['aa']."</button>
...
$(function(){  
 $("button.SalvarAdicionar").click(function() { 
		...
		$.post('EnviarOpcoesAdmin.php', {camposMarcados: camposMarcados, rev: rev, status: status}, function(resposta) {
				$("#StatusModal").html('');

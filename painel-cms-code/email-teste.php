...
$CadUser = InfoUser(2);
$SQL = "SELECT * FROM email_teste WHERE CadUser = :CadUser";
...
?>
	...
	<!-- START BREADCRUMB -->
                <ul class="breadcrumb">
                	<li>E-mail Teste</li>
                    <li class="active">E-mail Teste</li>
                </ul>
                <!-- END BREADCRUMB -->  
                
                <!-- PAGE TITLE -->
          <div class="page-title">                    
          <h2><span class="fa fa-envelope-o"></span> E-mail Teste</h2>
          </div>
                <!-- END PAGE TITLE -->   
                ...
                <div class="page-content-wrap">                
                    ...
                    <div class="row">
                        ...
                        <div class="panel panel-danger">
                                ...
                                <?php
                                echo "<button onclick=\"Adicionar();\" type=\"button\" class=\"Adicionar btn btn-info active\">".$_TRA['Adicionar']."</button>";
                                ?>
                               ...
                               <thead>
								...
								echo "<a onclick=\"Editar('".$Ln['id']."');\" class=\"label label-warning\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"\" data-original-title=\"".$_TRA['editar']."\"><i class=\"fa fa-pencil\"></i></a>&nbsp;";
								
								echo "<a onclick=\"Deletar('".$Ln['id']."', '".$Ln['email']."');\" class=\"deletar label label-danger\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"\" data-original-title=\"".$_TRA['excluir']."\"><i class=\"fa fa-trash-o\"></i></a>&nbsp;";
...
<!-- START SCRIPTS -->
		...
		function Editar(id){
				...
				$.post('ScriptModalEditarEmailEditar.php', {id: id}, function(resposta) {
		...
		function Adicionar(){
				...
				$.post('ScriptModalAdicionarEmailTeste.php', function(resposta) {

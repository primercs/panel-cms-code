                ...
                <div class=\"modal-content\">
                    ...
                    <div class=\"modal-body form-horizontal form-group-separated\">     
						...
						<div class=\"form-group\">
							...
							".SelecionarModeloPreferenciasSMS('Painel','DadosDeAcesso')."
							</select>
                            </div>
                        </div>
						...
						<div class=\"form-group\">
							...
							".SelecionarModeloPreferenciasSMS('Painel','DadosDeAcessoTeste')."
							</select>
                            </div>
                        </div>
						...
						<div class=\"form-group\">
							...
							".SelecionarModeloPreferenciasSMS('Painel','Vencimento')."
							</select>
                            </div>
                        </div>
						...
						<div class=\"form-group\">
							...
							".SelecionarModeloPreferenciasSMS('Painel','Renovacao')."
							</select>
                            </div>
                        </div>
...
$(function(){  
 $("button.SalvarModelo").click(function() { 
		...
		$.post('EnviarPrefSMSModelo.php', Data, function(resposta) {
				$("#StatusModal").html('');

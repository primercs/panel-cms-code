                ...
                <div class=\"modal-content\">
                    ...
                    <div class=\"modal-body form-horizontal form-group-separated\">     
                        ...
                        <div class=\"form-group\">
                            ...
                            <div class=\"col-md-9\">
                                <input id=\"ClientID\" name=\"ClientID\" type=\"text\" class=\"validate[required] form-control\">
                            </div>
                        </div>
						...
						<div class=\"form-group\">
                            ...
                            <div class=\"col-md-9\">
                                <input id=\"ClientSecret\" name=\"ClientSecret\" type=\"text\" class=\"validate[required] form-control\">
                            </div>
                        </div>
...
$(function(){  
 $("button.SalvarForma").click(function() { 
		...
		$.post('EnviarAdicionarFormaMercadoPago.php', Data, function(resposta) {
				$("#StatusModal").html('');

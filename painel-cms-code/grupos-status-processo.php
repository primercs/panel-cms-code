...
UNION ALL 
SELECT id, CadUser, nome, usuario, senha, email, foto, perfil, bloqueado, data_premio, conexao, xml, celular, grupo, PrePago FROM usuario) as newt WHERE FIND_IN_SET(newt.CadUser,:CadUser)".$PesStatus.$PesPerfil."";
...
SELECT id, CadUser, nome, usuario, senha, email, foto, perfil, bloqueado, data_premio, conexao, xml, celular, grupo, PrePago FROM teste 
UNION ALL 
SELECT id, CadUser, nome, usuario, senha, email, foto, perfil, bloqueado, data_premio, conexao, xml, celular, grupo, PrePago FROM usuario) as newt WHERE newt.CadUser = :CadUser".$PesStatus.$PesPerfil."";

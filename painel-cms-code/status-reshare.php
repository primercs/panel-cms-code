...
?>
	...
	<!-- START BREADCRUMB -->
                <ul class="breadcrumb">
                    ...
                    <li class="active"><?php echo $_TRA['Reshare']; ?></li>
                </ul>
                <!-- END BREADCRUMB -->  
                
                <!-- PAGE TITLE -->
          <div class="page-title">                    
          <h2><span class="fa fa-dot-circle-o"></span> <?php echo $_TRA['Reshare']; ?></h2>
          </div>
                <!-- END PAGE TITLE -->   
		...
		$(function(){  
 			$("button.ExibirStatus").click(function() {
				...
				$.post('EnviarStatusReshare.php', {caduser: caduser, rev: rev, perfil: perfil}, function(resposta) {

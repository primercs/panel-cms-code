                ...
                <div class=\"modal-content\">
                    ...
                    <div class=\"modal-body form-horizontal form-group-separated\">     
						...
						<div class=\"form-group\">
                            ...
                            <div class=\"col-md-9\">
                                <input id=\"EditarSenha\" name=\"EditarSenha\" type=\"text\" class=\"validate[required] form-control\" value=\"".$senha."\">
                            </div>
                        </div>
						<div class=\"form-group\">
						...
						<div class=\"form-group\">
                        	<label class=\"col-md-3 control-label\">".$_TRA['conexao']."</label>
                            	<div class=\"col-md-9\">
                                	<input type=\"text\" name=\"EditarConexao\" id=\"EditarConexao\" class=\"form-control spinner_default\" value=\"".$conexao."\"/>
                                </div>
                        </div>";
						...
						<div class=\"form-group\">
                            ...
                            <div class=\"col-md-9\">
                                <input id=\"ValorCobrado\" name=\"ValorCobrado\" type=\"text\" class=\"form-control\" value=\"".$ValorCobradoCab."\">
                            </div>
                        </div>

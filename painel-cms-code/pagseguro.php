...
$SQL = "SELECT id, email, token, bloqueado FROM contapagseguro WHERE CadUser = :CadUser";
...
?>
	...
	<!-- START BREADCRUMB -->
                <ul class="breadcrumb">
                    ...
                    <li class="active"><?php echo $_TRA['PagSeguro']; ?></li>
                </ul>
                <!-- END BREADCRUMB -->  
                
                <!-- PAGE TITLE -->
          <div class="page-title">                    
          <h2><span class="fa fa-chevron-right"></span> <?php echo $_TRA['PagSeguro']; ?></h2>
          </div>
                <!-- END PAGE TITLE -->   
...
<!-- START SCRIPTS -->
		...
		function BloquearMetodo(id){ 
				...
				var tipo = 'danger';
				var url = 'EnviarBloquearPagSeguro';
				var fa = 'fa fa-lock';  
		...
		function DesbloquearMetodo(id){ 
				...
				var tipo = 'danger';
				var url = 'EnviarDesbloquearPagSeguro';
		...
		function InformacoesForma(id){
				...
				$.post('ScriptModalInfoFormaPagSeguro.php', {id: id}, function(resposta) {
		...
		function DeletarForma(id, email){
				...
				var tipo = 'danger';
				var url = 'EnviarDeletarFormaPagSeguro';
		...
		function EditarForma(id){  
				...
				panel_refresh($(".page-container")); 
				$.post('ScriptModalFormaPagSeguroEditar.php', {id: id}, function(resposta) {
		...
		function AdicionarForma(){ 
				...
				$.post('ScriptModalFormaPagSeguro.php', function(resposta) {

...
$ColunaAcesso = array('AdminVisualizar');
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	$SQLUser = "SELECT CadUser, celular FROM admin WHERE usuario = :usuario";
	...
	if($EnviarSMS == 1){
		echo MensagemAlerta($_TRA['sucesso'], $_TRA['secs'], "success", "index.php?p=administrador");
	}
	else{

            ...
            <div class=\"modal-dialog\">
                <div class=\"modal-content\">
                    <div class=\"modal-header\">
                        ...
                        <h4 class=\"modal-title\" id=\"smallModalHead\">".$_TRA['av']."</h4>
                    </div>
                    ...
                    <div class=\"modal-footer\">
                        ...
                        <button type=\"button\" class=\"SalvarAdicionar btn btn-warning\">".$_TRA['av']."</button>
...
$(function(){  
 $("button.SalvarAdicionar").click(function() { 
		...
		var EditarValorCobrado = $('#EditarValorCobrado').val();
		var EditarValorCobradoCab = $('#EditarValorCobradoCab').val();
		...
		$.post('EnviarOpcoesUser.php', {camposMarcados: camposMarcados, status: status, EditarValorCobrado: EditarValorCobrado, EditarValorCobradoCab: EditarValorCobradoCab}, function(resposta) {
				$("#StatusModal").html('');

...
$ColunaAdmin = array('AdminLogin');
$VerificarAcesso = VerificarAcesso('admin', $ColunaAdmin);
$AdminLogin = $VerificarAcesso[0];
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	$SQLUser = "SELECT CadUser FROM admin WHERE usuario = :usuario";
	...
	elseif(VerificarUsuarioEditar($UserNovo, NULL, 1) == 1) {
	...
	if(empty($SQL)){
		...
		echo MensagemAlerta($_TRA['sucesso'], $_TRA['uacs'], "success", "index.php?p=administrador");
	}

            ...
            <div class=\"modal-dialog\">
                <div class=\"modal-content\">
                    <div class=\"modal-header\">
                        ...
                        <h4 class=\"modal-title\" id=\"smallModalHead\">Configurar E-mail</h4>
                    </div>
                    <div class=\"modal-body form-horizontal form-group-separated\">     
						...
						<div class=\"form-group\">
                        	<label class=\"col-md-3 control-label\">E-mail</label>
                            	<div class=\"col-md-9\">
                                	<input type=\"text\" name=\"RedeSocial\" id=\"RedeSocial\" class=\"form-control\" value=\"".$email."\"/>
                                </div>
                        </div>
...
$(function(){  
 $("button.SalvarCaptcha").click(function() { 
		...
		$.post('EnviarConfigurarEmail.php', Data, function(resposta) {

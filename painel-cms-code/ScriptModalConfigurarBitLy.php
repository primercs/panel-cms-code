            ...
            <div class=\"modal-dialog\">
                <div class=\"modal-content\">
                    <div class=\"modal-header\">
                        ...
                        <h4 class=\"modal-title\" id=\"smallModalHead\">Configurar Bit.ly</h4>
                    </div>
                    <div class=\"modal-body form-horizontal form-group-separated\">     
						...
						<div class=\"form-group\">
                        	<label class=\"col-md-3 control-label\">API Key</label>
                            	<div class=\"col-md-9\">
                                	<input type=\"text\" name=\"api\" id=\"api\" class=\"form-control\" value=\"".$api."\"/>
                                </div>
                        </div>
...
$(function(){  
 $("button.SalvarCaptcha").click(function() { 
		...
		$.post('EnviarConfigurarBitLy.php', Data, function(resposta) {

...
$UserOnline = InfoUser(2);
	...
	$SQL = "SELECT id, CadUser, nome, usuario, senha, email, foto, perfil, bloqueado, inativo, data_premio, PrePago, Cota, CotaDias, celular FROM rev WHERE usuario = :usuario";
...
if( !empty($requestData['search']['value']) ) {
	...
	$SQLss->bindParam(':usuario', $CadUser, PDO::PARAM_STR);
	$SQLss->execute();
